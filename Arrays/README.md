...
Problems that use **arrays** as the primary data structure, including traversal, searching, sorting, two pointers, matrix manipulation, and other array-based techniques.
